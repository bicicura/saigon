...
<div class="px-3.5 lg:px-8 mt-28 space-y-3 index-article lg:mt-0" style="height: 100vh">
    ...
    <div class="hidden space-y-4 text-black lg:space-y-6 vidick snap-start lg:block" >
        ...
        <div class="lg:flex lg:items-end lg:justify-between home-intro">
            <div class="lg:w-6/12 lg:space-y-6">
                <p>En Saigón somos un equipo creativo y multidisciplinario con más de diez años de experiencia dedicado a la producción de casting. Asesoramos durante todo el proceso de búsqueda, realizamos los castings de forma presencial en nuestro estudio así como también remotos.</p>
                <p>Ofrecemos distintos servicios en producción de casting: ficción, comerciales, gráfica, street casting y proyectos especiales; tanto nacionales como internacionales.  Nuestro enfoque se adecúa a las necesidades específicas de cada proyecto y se apoya en la organización y profesionalismo con el que trabajamos.</p>
            </div>
    ...
    <div class="relative z-30 lg:mt-16 snap-start">
        <div class="mb-12">
            <x-section-hero :title="'CASTING COMERCIALES'" :description="'Realizamos servicios de casting para proyectos comerciales nacionales e internacionales. Nuestro estudio esta equipado con varias salas y contamos con un staff altamente capacitado y competente. Tenemos un abordaje integral, mas de diez años de experiencia trabajando con productoras, lo que nos da la excelencia que requiere el mercado publicitario.'" />
