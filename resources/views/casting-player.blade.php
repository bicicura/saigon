...
class="fixed bottom-0 left-0 z-50 w-full text-white saigon-bg-black-2">
    ...
    <div class="relative flex items-center gap-2 py-8 mx-auto w-max">
        ...
        <p class="tracking-wider saigon-text-200">— LA NUEVA AGENCIA DE MODELOS DE SAIGÓN → <a href="https://streetagency.xyz/" target="_blank" style="color: #58595B">WWW.STREETAGENCY.XYZ</a></p> 
