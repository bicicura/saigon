...
<div class="w-full pt-24 text-saigon-black lg:pt-0">
    <div class="z-10 items-baseline justify-between px-3.5 lg:px-0 py-6 pt-8 lg:w-10/12 lg:flex">
        ...
        <div class="flex flex-col-reverse items-end lg:items-center lg:flex-row">
            <div class="flex flex-col-reverse items-end justify-end gap-3 text-right lg:items-baseline lg:flex-row lg:text-left saigon-text-500 lg:ml-8">
                <div>
...
<script defer>
    if (window.innerWidth < 800) {
        let setHeroHeight = () => {
            ...
            hero.style.height = `calc(${vh} - 30rem)`;
        }
