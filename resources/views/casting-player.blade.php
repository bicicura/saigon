...
<div class="w-full text-saigon-black">
    <div class="z-10 items-baseline justify-between w-10/12 py-6 pt-8 lg:flex">
        ...
        <div class="flex items-center">
            <div class="flex items-baseline justify-end gap-3 saigon-text-500 lg:ml-8">
                <div class="w-3">
                ...
                <h1><span class="uppercase">{{$casting['nombre']}}</span> — {{$casting['director']}} | {{$casting['productora']}} </h1>
            </div>
            <div class="ml-3">
...
<div 
    ...
    <div x-on:click="show = false" class="absolute text-transparent cursor-pointer right-6 top-6 hover:text-saigon-white">
    ...
    <div class="relative flex items-center gap-2 py-8 mx-auto w-max">
        ...
        <p class="tracking-wider saigon-text-100">— LA NUEVA AGENCIA DE MODELOS DE SAIGÓN → <a href="https://streetagency.xyz/" target="_blank" class="saigon-text-blue hover:underline">WWW.STREETAGENCY.XYZ</a></p> 
