...
<div class="w-full">
    <div class="z-10 items-baseline justify-between w-10/12 py-6 pt-8 lg:flex">
        <div class="hidden ml-8 logo-fixed lg:block ">
        ...
        <div class="flex items-baseline">
            <div class="flex items-baseline justify-end gap-2 lg:text-2xl lg:ml-8">
                <div class="w-3">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 27 32" xml:space="preserve"><path fill="none" stroke="#000" stroke-width="2" stroke-miterlimit="10" d="m26.3 18-13 13L.4 18M13.4 0v31"></path></svg>
                </div>
                <h1>{{$casting['nombre']}} — {{$casting['director']}} | {{$casting['productora']}} </h1>
                
            </div>
            <div class="ml-3">
                <a href="{{$casting->getWebUrl()}}/" class="text-transparent hover:text-saigon-black">
                    <svg class="w-4 h-4 transition-colors duration-150 ease-in cursor-pointer" version="1.1" id="Layer_1" x="0" y="0" viewBox="0 0 24 24" xml:space="preserve"><path fill="currentColor" class="stroke-saigon-black hover:stroke-saigon-white" stroke-miterlimit="10" d="M.5.5h22.45v22.45H.5zM16.91 16.91 6.54 6.54M6.54 16.91 16.91 6.54"/></svg>
                </a>
            </div>
        </div>
    </div>
    <div class="lg:pl-8 lg:w-10/12 player-height pl-3.5 pr-3.5 lg:pr-0 pt-20 lg:pt-0">
        <h1 class="block mb-3 lg:hidden">{{$casting['nombre']}} — {{$casting['director']}} | {{$casting['productora']}} </h1>
        @if (Str::contains($casting['url'] , 'vimeo'))
            <iframe src="{{$casting['url']}}" class="w-full aspect-video rounded-2xl" frameborder="0" allow="autoplay; fullscreen" allow></iframe>
        @else
...
<div 
    ...
    <svg x-on:click="show = false" class="absolute w-4 cursor-pointer right-6 top-6" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" x="0" y="0" viewBox="0 0 23.45 23.45" xml:space="preserve"><path fill="none" stroke="#F2F2F2" stroke-miterlimit="10" d="M.5.5h22.45v22.45H.5zM16.91 16.91 6.54 6.54M6.54 16.91 16.91 6.54"/></svg>
    <div class="relative flex items-center gap-2 py-8 mx-auto w-max">
        ...
        <p class="tracking-wider saigon-text-200">— LA NUEVA AGENCIA DE MODELOS DE SAIGÓN → <a href="https://streetagency.xyz/" target="_blank" class="saigon-text-blue">WWW.STREETAGENCY.XYZ</a></p> 
        <p style="font-size: 1.5rem">|</p>
        <p class="tracking-wider saigon-text-200">Seguimos en instagram: <a href="https://www.instagram.com/streetagency.xyz/" target="_blank">@streetagency.xyz</a></p>
    </div>
</div>
