...
<div
    {{-- scrollToFlag se va a marcar True si el user clickea la cruz. Esta flag indica si escrolear para abajo o no cuando estas en la seccion Mini y Castings. --}}
    x-data=" { navOpenFlag: false, scrollToFlag: $persist(false).using(sessionStorage) } "
    ...
    <div class="z-10 items-baseline justify-between px-3.5 lg:px-0 py-6 pt-8 lg:w-10/12 lg:flex">
        ...
        <div class="flex flex-col-reverse items-end lg:items-center lg:flex-row">
            ...
            <div class="mb-4 lg:ml-3 lg:mb-0">
                <a x-ref="backBtn" x-on:click="scrollToFlag = true; window.location.href = '{{$casting->getWebUrl()}}' " class="text-transparent hover:text-saigon-black">
...
<div 
    ...
    <div class="relative flex flex-col items-center gap-2 py-8 text-center lg:mx-auto lg:flex-row lg:w-max">
        ...
        <p class="tracking-wider saigon-text-100">Seguinos en Instagram: <a href="https://www.instagram.com/streetagency.xyz/" class="hover:underline" target="_blank">@streetagency.xyz</a></p>
    </div>
</div>
