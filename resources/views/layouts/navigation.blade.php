            ...
            <div class="flex">
                ...
                <div class="flex items-center shrink-0">
                    <a href="{{ route('dashboard', app()->getLocale()) }}">
                        <div class="w-12">
                            <x-application-logo class="block w-auto my-3 text-gray-600 fill-current" />
                        </div>
                    </a>
                </div>
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    <x-nav-link :href="route('dashboard.productoras', app()->getLocale())" :active="request()->routeIs('dashboard.productoras')">
                        Productoras
                    </x-nav-link>
