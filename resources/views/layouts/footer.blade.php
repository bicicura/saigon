<footer class="saigon-text-white saigon-bg-black px-3.5 py-12 space-y-8 text-xl border-white relative lg:hidden">
    <div class="w-full p-px saigon-bg-white"></div>
    <div class="w-7/12">
    ...
    <div>
        <p class="hover:underline"><a href="https://goo.gl/maps/A4zVVJKth3oGkJx37" target="_blank">Bonpland 2362, Palermo</a></p>
...
<script>
    if (document.querySelector('.smooth-scroll') != null) {
        ...
        // evento para scrollar al bottom del site, lo utilizo para cuando se cierra un casting, vuelva adonde estaba el user
        window.addEventListener('goBottom', (e) => {
            let target;
            e.detail.scrollToId == 0? target = "top" : target = document.querySelector('#'+e.detail.scrollToId);
            // target, offset y duration
            locoScroll.scrollTo(target, -200, 1500);
        })
    }
</script>
