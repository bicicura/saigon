<header
    ...
    @skills-close-flag.window="skillsFlag = false"
    ...
    <nav id="nav-header" :class="{ 'border-nav-mov' : open, 'border-saigon-black' : open == false, 'saigon-bg-black-mobile' : openForm }" class="pt-3.5 pr-3.5 pl-3.5 lg:pl-0 lg:pt-0 lg:pb-0 lg:pr-4 flex lg:flex-col lg:min-h-full justify-between z-20 lg:border-r saigon-transition-border-color pb-2 lg:border-0">
        ...
        <div class="flex-col items-end justify-between hidden md:flex lg:mt-auto">
            <span x-on:click="openForm=true; open=true; openBurger = true" class="mt-auto uppercase cursor-pointer texto-vertical" x-text="skillsFlag? 'SKILLS' : '{{ __('Sumate a Saigon') }}'"></span> 
        </div>
