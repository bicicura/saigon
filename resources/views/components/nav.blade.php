<header
    ...
    <nav id="nav-header" :class="{ 'border-nav-mov' : open, 'border-saigon-black' : open == false }" class="pt-3.5 pr-3.5 pl-3.5 lg:pl-0 lg:pt-0 lg:pb-0 lg:pr-4 flex lg:flex-col lg:min-h-full justify-between z-20 lg:border-r saigon-transition-border-color pb-2 lg:border-0">
