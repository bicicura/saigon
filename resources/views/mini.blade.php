        ...
        <div class="z-20 flex flex-col items-end gap-4 mt-32 text-right lg:ml-auto lg:gap-8 lg:mt-16">
            ...
            <div class="w-full saigon-text-300 saigon-p-line-height hero-p-w">
                ...
                <div>
                    ...
                    <p><span class="block lg:inline">Melanie Semhan</span><span class="hidden lg:inline lg:mx-1">  |  </span><span class="block lg:inline hover:underline"><a href="mailto:mini@saigonbuenosaires.com">mini@saigonbuenosaires.com</a></span></p>
                </div>
            </div>
        </div>
