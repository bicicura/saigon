<form wire:submit.prevent="submit" class="w-full pb-12 space-y-6 text-xl text-white lg:space-y-7 saigon-font-thin px-7 lg:px-0 lg:mt-12 lg:pr-16 lg:w-full">
    ...
    <div class="gap-8 lg:grid lg:grid-cols-3 lg:pt-6 lg:w-8/12">
