        ...
        <table class="w-full mx-auto bg-gray-200 divide-y rounded-xl h-fit">
            <thead>
              <tr>
                ...
                <th class="px-6 py-3 text-xs font-bold leading-4 tracking-wider text-left text-gray-500 uppercase">CELULAR</th>
              ...
              @foreach ($interesados as $interesado)
                <tr class="hover:shadow-md" >
                    ...
                    <td class="flex items-center justify-end gap-6 px-6 py-6">
                        <a href="inbox/{{ $interesado->id }}" title="Visualizar">
                        ...
                        <div class="cursor-pointer" @click="deleteModal = true; perfilId = {{$interesado->id}}, perfilNombre = '{{$interesado->nombre}}'" title="Eliminar">
