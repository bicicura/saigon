<div class="gap-4 mt-4 lg:grid lg:grid-cols-3">
    ...
    <section class="pt-4 pb-8 text-right border-t-2 border-black saigon-text-white lg:text-left lg:pb-0 lg:pt-0 lg:border-t-0 casting-article">
        ...
        <a href="{{ route('casting-player', [app()->getLocale(), $item['id']]) }}" class="relative flex flex-col justify-between bg-center bg-no-repeat bg-cover cursor-pointer h-96 lg:h-fit lg:py-28 lg:aspect-video rounded-xl" style="background-image: url('/thumbnails/{{$item['thumbnail']}}')">
            ...
            <div class="absolute inset-0 top-0 bottom-0 left-0 right-0 flex items-center justify-center card-play-button">
                <div class="flex items-center gap-2 px-3 py-px bg-black rounded-full w-max h-fit">
                    <svg width="15" height="15" viewBox="0 0 15 15" class="hidden mr-2 lg:block"><g fill="none" fill-rule="evenodd"><path d="M-1-1h18v18H-1z"></path><path class="fill-current" d="M6 10.875L10.5 7.5 6 4.125v6.75zM7.5 0C3.36 0 0 3.36 0 7.5 0 11.64 3.36 15 7.5 15c4.14 0 7.5-3.36 7.5-7.5C15 3.36 11.64 0 7.5 0zm0 13.5c-3.307 0-6-2.693-6-6s2.693-6 6-6 6 2.693 6 6-2.693 6-6 6z"></path></g></svg>
