<div>
    ...
    <div style="z-index: 9999" class="fixed top-0 px-3.5 lg:px-0 left-0 flex items-center justify-center w-full min-h-screen bg-saigon-black bg-opacity-90 text-saigon-white">
        <div class="lg:max-w-4xl">
            <div class="relative z-50 items-start gap-4 space-y-4 lg:flex-row-reverse lg:space-y-0 lg:flex splide">

                <div class="px-3.5 lg:px-0 flex flex-row-reverse justify-between w-full leading-tight lg:w-max lg:block">
                    <div wire:click="close" class="mb-4">
                        <button type="button" class="relative p-4 focus:outline-none">
                    ...
                    <div>
                        ...
                        <p class="saigon-text-200 w-max">{{$CastingSelected['productora']}}</p>
                    </div>
                </div>
                ...
                <div class="splide__arrows">
                    <div class="overflow-hidden splide__track aspect-video">
                        <ul class="splide__list">
                                @foreach ($CastingSelected->getFotografias as $foto)
